...
var ProjectWhere = struct {
	...
	RepoName:  whereHelperstring{field: `repo_name`},
	RepoOwner: whereHelperstring{field: `repo_owner`},
}
...
var (
	projectColumns               = []string{"id", "name", "repo_name", "repo_owner"}
	projectColumnsWithoutDefault = []string{"name", "repo_name", "repo_owner"}
...
func (o *Project) Contributors(mods ...qm.QueryMod) userQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"project_users\" on \"users\".\"id\" = \"project_users\".\"user_id\""),
...
func (projectL) LoadContributors(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.From("\"users\""),
		qm.InnerJoin("\"project_users\" as \"a\" on \"users\".\"id\" = \"a\".\"user_id\""),
	...
	if singular {
		object.R.Contributors = resultSlice
	...
	for i, foreign := range resultSlice {
		...
		for _, local := range slice {
			if local.ID == localJoinCol {
				local.R.Contributors = append(local.R.Contributors, foreign)
				if foreign.R == nil {
					foreign.R = &userR{}
				}
...
// AddContributors adds the given related objects to the existing relationships
// of the project, optionally inserting them as new records.
// Appends related to o.R.Contributors.
...
func (o *Project) AddContributors(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	...
	for _, rel := range related {
		query := "insert into \"project_users\" (\"project_id\", \"user_id\") values ($1, $2)"
	...
	if o.R == nil {
		...
		o.R.Contributors = append(o.R.Contributors, related...)
	}
...
// SetContributors removes all previously related items of the
// project replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Projects's Contributors accordingly.
// Replaces o.R.Contributors with related.
// Sets related.R.Projects's Contributors accordingly.
func (o *Project) SetContributors(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	query := "delete from \"project_users\" where \"project_id\" = $1"
	...
	removeContributorsFromProjectsSlice(o, related)
	if o.R != nil {
		o.R.Contributors = nil
	}
	return o.AddContributors(ctx, exec, insert, related...)
}

// RemoveContributors relationships from objects passed in.
// Removes related items from R.Contributors (uses pointer comparison, removal does not keep order)
...
func (o *Project) RemoveContributors(ctx context.Context, exec boil.ContextExecutor, related ...*User) error {
	var err error
	query := fmt.Sprintf(
		"delete from \"project_users\" where \"project_id\" = $1 and \"user_id\" in (%s)",
	...
	for _, rel := range related {
		for i, ri := range o.R.Contributors {
			if rel != ri {
				continue
			}

			ln := len(o.R.Contributors)
			if ln > 1 && i < ln-1 {
				o.R.Contributors[i] = o.R.Contributors[ln-1]
			}
			o.R.Contributors = o.R.Contributors[:ln-1]
			break
		}
	}
...
func removeContributorsFromProjectsSlice(o *Project, related []*User) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
